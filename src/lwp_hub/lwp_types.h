...
typedef enum
{
    SUBCMD_START_POWER_NA = 0x00,
    SUBCMD_START_POWER = 0x02,
    SUBCMD_SZT_ACC_TIME = 0x05,
    SUBCMD_SZT_DEC_TIME = 0x06,
    SUBCMD_START_SPEED = 0x07,
    SUBCMD_START_SPEED_2 = 0x08,
    SUBCMD_START_SPEED_FOR_TIME = 0x09,
    SUBCMD_START_SPEED_FOR_TIME_2 = 0x0A,
    SUBCMD_START_SPEED_FOR_DEGREES = 0x0B,
    SUBCMD_START_SPEED_FOR_DEGREES_2 = 0x0C,
    SUBCMD_GOTO_ABS_POS = 0x0D,
    SUBCMD_GOTO_ABS_POS_2 = 0x0E,
    SUBCMD_PRESET_ENCODER_NA = 0x00,
    SUBCMD_PRESET_ENCODER = 0x14,
    SUBCMD_TILT_IMPACT_PRESET_NA = 0x00,
    SUBCMD_TILT_CONFIG_ORIENTATION_NA = 0x00,
    SUBCMD_TILT_CONFIG_IMPACT_NA = 0x00,
    SUBCMD_HARDWARE_RESET_NA = 0x00,
    SUBCMD_SET_RGB_COLOR_NA = 0x00,
    SUBCMD_SET_RGB_COLOR_NA_2 = 0x00,
    SUBCMD_WRITE_DIRECT = 0x50,
    SUBCMD_WRITE_DIRECT_MODE_DATA = 0x51,
} e_port_output_subcommand_t;
